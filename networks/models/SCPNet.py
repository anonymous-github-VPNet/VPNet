...
from networks.models.SCPNet_Completion import SCPNet_Completion
from networks.models.SCPNet_3D_UNet import Asymm_3d_spconv
...
class SCPNet(nn.Module):
    def __init__(self, class_num, input_dimensions, class_frequencies, pt_model='pointnet', fea_dim=3, pt_pooling='max', kernal_size=3, out_pt_fea_dim=128, fea_compre=32):
        ...
        self.SSCNet = SCPNet_Completion(self.fea_compre)
