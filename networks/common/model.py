...
from networks.models.SSA_SC_v7_b3 import SSA_SC_v7_b3
...
def get_model(_cfg, dataset):
    ...
    # VPNet --------------------------------------------------------------------------------------------------------
    elif selected_model == 'SSA_SC_v7_b3':
        model = SSA_SC_v7_b3(class_num=nbr_classes, input_dimensions=grid_dimensions, class_frequencies=class_frequencies, pt_model='pointnet', fea_dim=7, pt_pooling='max', kernal_size=3, out_pt_fea_dim=512, fea_compre=32)
    # ------------------------------------------------------------------------------------------------------------------
